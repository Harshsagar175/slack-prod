            ...
            <div className="flex items-center px-3.5 group">
                ...
                {onNew && (
                    <Hint label={hint} side="top" align="center">
                        <Button variant="transparent" onClick={onNew} size="iconSm" className="group-hover:opacity-100 transition-opacity ml-auto p-0.5 text-sm text-[#f9edffcc] size-6 shrink-0">
